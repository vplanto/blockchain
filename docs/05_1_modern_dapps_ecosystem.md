...
```
[Схема взаємодії компонентів Web3 dApp](images/dapp_architecture.png)
...
> [!TIP]
> **Практичний практикум:** Детальний розбір реалізації та деплою NFT за стандартом ERC-721 наведено у **[Практикумі p02: Архітектура NFT (ERC-721)](./workshops/p02_nft_erc721.md)**. Самостійні завдання на проектування ERC-20 та інших токенів доступні у **[Практикумі p03: Самостійні завдання](./workshops/p03_solidity_individual_tasks.md)**.
...
graph TD
    ...
    class Impl2 impl2;
```
[Схема Proxy-патерну оновлюваних смарт-контрактів](images/proxy_pattern.png)
...
> [!TIP]
> **Практичний практикум:** Покрокове керівництво з налаштування локального середовища Foundry, написання тестів на Solidity, fuzz-тестування та взаємодії з форком мережі описано у **[Практикумі p04: Foundry — локальне середовище](./workshops/p04_foundry_local_dev.md)**.
