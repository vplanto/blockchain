...
### 1. Контекст Інциденту
Tornado Cash — це децентралізований протокол (міксер) на базі Ethereum, який дозволяє користувачам розривати зв'язок між адресою відправника та отримувача. У серпні 2022 року Міністерство фінансів США (OFAC) внесло смарт-контракти Tornado Cash до санкційного списку, стверджуючи, що через них відмиваються кошти хакерських угруповань (наприклад, Lazarus Group).
