...
Зміст лекцій і практикумів узгоджено з темами офіційної робочої програми; відповідність описана в [Відповідність РП](./syllabus_mapping.md).
...
* **Фокус:** Читання коду Solidity, стан, газ, require, патерни безпеки. Приклади з папки [solidity](../solidity/) та Remix IDE.
...
Практичний досвід: робота з кодом у Remix IDE, приклади з папки [solidity](../solidity/).
...
* [Приклади коду Solidity](../solidity/) — контракти HelloWorld, Voter (v1–v4) для Remix. Шлях від кореня репозиторію: `solidity/`, від папки docs: `../solidity/`.
