...
Робоча програма (п. 11) містить **80 питань** для поточного та періодичного контролю (блокчейн як мережа, генезис-блок, хешування, PoW/PoS, TPS, приватність, форк, DDoS тощо). Ці питання можна використовувати разом із **екзаменаційними блоками** в кінці кожної лекції та практикуму в цій документації.
