...
| 12 | Приклади та методи побудови dApps | [Лекція 5](05_smart_contracts_solidity.md), [p00](workshops/p00_remix_solidity_basics.md); приклади коду в папці [solidity](../solidity/) |
