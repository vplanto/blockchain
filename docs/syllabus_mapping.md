...
| 2 | Побудова сучасних децентралізованих систем | Лекція 0 (Web2/Web3, піраміда абстракції) |
| 3 | Блокчейн та не-блокчейн технології розподіленого реєстру | Лекції 1–2, симулятори консенсусу |
| 4 | Децентралізовані алгоритми обробки та узгодження | Лекція 1 (Paxos, Raft, VR, pBFT) |
| 5 | Протоколи консенсусу Proof of Work | [Лекція 4](04_consensus_algorithms.md), [pow.html](consensus/byzantine_algos/pow.html) |
| 6 | Протоколи консенсусу Proof of Stake | Лекція 4, [pos.html](consensus/byzantine_algos/pos.html) |
| 7 | Інші протоколи консенсусу | Лекція 1 (pBFT, VR), Лекція 4 (коротко про інші) |
...
| 12 | Приклади та методи побудови dApps | Лекція 5, практикуми; приклади коду в папці [solidity](../solidity/) |
| 13 | NFT, невзаємозамінні токени | РП; можна розширити практикуми (ERC-721) |
| 14 | DeFi, осередки децентралізованих фінансів | [case_studies](case_studies.md), практикум з безпеки |
| 15 | DAO, децентралізовані автономні організації | Case_Studies (The DAO), [p01](workshops/p01_security_checks_effects_interactions.md) (reentrancy, CEI) |
...
Розподіл балів за РП: по 5 балів за поточний контроль на лекціях (по 1 за модуль), по 15 балів за кожне з трьох індивідуальних завдань у модулі (разом 45 за модуль). Підсумок: 50 + 50 = 100 балів.
